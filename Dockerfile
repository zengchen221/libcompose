...
WORKDIR /go/src/github.com/zengchen221/libcompose
...
ENV COMPOSE_BINARY /go/src/github.com/zengchen221/libcompose/libcompose-cli
ENV USER root

# Wrap all commands in the "docker-in-docker" script to allow nested containers
ENTRYPOINT ["hack/dind"]

COPY . /go/src/github.com/zengchen221/libcompose
